...
/* Stagger scroll-entry animations for cards and contact grids */
...
VIEWS_FIELD = () => {
  ...
  return `
  <div class="head">
    <div class="eyebrow">On-Site Capture</div>
    <h1>Field mode</h1>
...
VIEWS_CONTACTS = () => {
  ...
  return `
  <div class="head">
    <div class="eyebrow">Identity Resolution</div>
    <h1>Contacts</h1>
  ...
  <div style="margin-top:32px">
    <div class="eyebrow">Pattern Recognition</div>
...
VIEWS_SIGNALS = () => {
  ...
  return `
  <div class="head">
    <div class="eyebrow">Text Mining</div>
    <h1>Signal miner</h1>
